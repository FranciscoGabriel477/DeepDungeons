...
public class ClassAttackState : State<ClassAttackState>
{
    protected PlayerController player;
    protected GameInput gameInput;
    public ClassAttackState(ClassAttackStateMachine parent, string stateName,PlayerController player) : base(parent, stateName)
    {
        this.player=player;
